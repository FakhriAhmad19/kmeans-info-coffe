        ...
        <div class="row g-0 w-100">
            ...
            <div class="col-md-6 d-none d-md-block image-section">
                <div class="image-overlay">
                    ...
                    <h1 class="fw-bold mb-3 display-5" style="font-size: 2rem;">Segmentasi Pelanggan Berdasarkan Pola Pembelian di Info Coffee Menggunakan Metode K-Means Clustering</h1>
